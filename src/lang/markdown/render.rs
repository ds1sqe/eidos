use super::{Item, Parser, Style};

use egui::{
    Align, Align2, Hyperlink, Layout, Response, RichText, Sense, Separator,
    Shape, TextStyle, Ui, vec2,
};

/// Parse and display a VERY simple and small subset of Markdown.
pub fn render(ui: &mut Ui, easy_mark: &str) {
    render_items(ui, Parser::new(easy_mark));
}

pub fn render_items<'em>(ui: &mut Ui, items: impl Iterator<Item = Item<'em>>) {
